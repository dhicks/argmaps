...
Using Mermaid Live is simple:  simply open a web browser to <https://mermaid.live>, and you should see the same thing as @fig-sandbox.  Since you'll be creating argument maps pretty regularly in this class, you'll probably want to bookmark that link.  

![[The Argdown Sandbox: <https://argdown.org/sandbox/>]{.todo}](img/sandbox.png){#fig-sandbox}
