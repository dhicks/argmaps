# Case study: The biofuels debate {#sec-biofuels}
...
C("Oil refineries in the Bay Area should 
   switch to processing renewable feedstocks 
   to create biofuels.")
```
...
Pcarbon("Renewable feedstocks emit less carbon.")
Pcarbon --> C

Ppm("Renewable feedstocks have less PM emissions.")
Ppm --> C
```
...
Ppalm-oil("Virgin palm oil does not
           have these pollution benefits.")
Onot-all-feedstocks("Not all renewable feedstocks
                     have these pollution benefits.")
Ppalm-oil --> Onot-all-feedstocks -.-> Pcarbon
...
Onot-all-feedstocks("Not all renewable feedstocks
                     have these pollution benefits.")
Ppalm-oil --> Onot-all-feedstocks --- OLfeedstocks["Not all feedstocks
                                                    objection"] -.-> Pcarbon

Ocarb-support("CARB doesn't support refineries 
               using feedstocks like virgin 
               palm oil.")
Ocarb-support -.-> OLfeedstocks
```
...
Ocarb-support("CARB doesn't support refineries 
               using feedstocks like virgin 
               palm oil.")
Ocarb-support --- OLcarb-support["CARB doesn't support
								  reply"] -.-> OLfeedstocks

Oregulation("CARB cannot control what 
             feedstocks refineries use.")
Oregulation -.-> OLcarb-support
```
...
Olcfs("The low carbon fuel standard will 
       require refineries to only use 
       feedstocks with lower carbon emissions") -.-> Oregulation
```
...
Oev("We should be switching to electric 
     vehicles instead of producing biofuels") --- OLev["Electric vehicles
     													opposing argument"] -.-> C
```
...
Oheavy-duty("Planes, trains, and large ships 
			 cannot be electrified for several 
			 decades") -.-> OLev
```
